...
/* Esta función se utiliza tanto para calcular el módulo entre el índice del arreglo unidimensional y 3, como para llamar a las funciones correspondientes para resolver el problema. */
{
    int I;
