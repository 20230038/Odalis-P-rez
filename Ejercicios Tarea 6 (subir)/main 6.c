...
/* Casa de bolsa.
El programa, al recibir como datos los precios mensuales de las acciones de sus cinco fondos de inversión,
además del precio de las acciones al 31 de diciembre del 2003, genera información estadística importante para la empresa. */
...
/* Esta función se utiliza para leer un arreglo bidimensional de tipo real de F filas y C columnas. */
{
    int I, J;
    for (I = 0; I < F; I++)
    {
...
/* Esta función se utiliza para leer un arreglo unidimensional de tipo real de T elementos. */
{
    int I;
    printf("\n");
    for (I = 0; I < T; I++)
...
/* La función F1 se utiliza para calcular el rendimiento anual de los fondos de inversión.
...
/* Esta función calcula el promedio anualizado de las acciones de los diferentes fondos. */
{
    int I, J;
    float SUM, PRO;
